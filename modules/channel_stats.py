...
@utils.export(
        "channelset",
        utils.BoolSetting("announce-new-peak-users",
...
class Module(ModuleManager.BaseModule):
    ...
    def on_join(self, event):
        ...
        if channel.get_setting("announce-new-peak-users", False) and new_peak[0] != False:
            channel.send_message("A new user peak has been reached! New peak: %s" % utils.irc.bold(str(new_peak[1])))
