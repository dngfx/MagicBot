...
class Socket(object):
    ...
    def __init__(self, socket: socket.socket, on_read: typing.Callable[["Socket", str], None], encoding: str = "utf8"):
        self.socket = socket
    ...
    def _send(self):
        self._write_buffer = self._write_buffer[self.socket.send(self._write_buffer):]
