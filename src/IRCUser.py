...
class User(IRCObject.Object):
    def __init__(
        self, nickname: str, id: int, server: "IRCServer.Server", bot: "IRCBot.Bot"
    ):
        self.name = ""
        self.nickname = ""
        self.nickname_lower = ""
    ...
    def get_channel_settings_per_setting(
    ...
    def wsend_message(self, message: str, tags: dict = {}):
