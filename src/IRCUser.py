...
class User(IRCObject.Object):
    ...
    def __init__(self, nickname: str, id: int, server: "IRCServer.Server", bot: "IRCBot.Bot"):
        self.name = ""
        self.nickname = ""
        self.nickname_lower = ""
    ...
    def get_setting(self, setting: str, default: typing.Any = None) -> typing.Any:
        return self.bot.database.user_settings.get(self.get_id(), setting, default)
    ...
    def find_setting(self,
        ...
        if not pattern == None:
            return self.bot.database.user_settings.find(self.get_id(), pattern, default)
        elif not prefix == None:
            return self.bot.database.user_settings.find_prefix(self.get_id(), prefix, default)
        else:
    ...
    def get_channel_settings_per_setting(self, setting: str, default: typing.Any = []) -> typing.List[typing.Any]:
