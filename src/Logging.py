...
class BitBotFormatter(logging.Formatter):
    ...
    def formatTime(self, record, datefmt=None):
        ...
        return utils.datetime.format.iso8601(datetime_obj, timespec=utils.datetime.TimeSpec.MILLISECOND)
...
class Log(object):
    ...
    def __init__(self, to_file: bool, level: str, location: str, file_levels: typing.List[str]):
        self._hooks = []
        ...
        if to_file:
            if "TRACE" in file_levels:
                ...
                trace_handler = logging.handlers.TimedRotatingFileHandler(trace_path, when="midnight", backupCount=5)
            ...
            if "INFO" in file_levels:
                ...
                info_handler = logging.handlers.TimedRotatingFileHandler(info_path, when="midnight", backupCount=1)
    ...
    def _log(self, message: str, params: typing.Optional[typing.List], level: int, kwargs: dict):
