...
class Request(object):
    ...
    get_params: typing.Dict[str, str] = dataclasses.field(default_factory=dict)
...
def _find_encoding(headers: typing.Dict[str, str], data: bytes) -> typing.Optional[str]:
    ...
    doctype = [item for item in soup.contents if isinstance(item, bs4.Doctype)] or None
