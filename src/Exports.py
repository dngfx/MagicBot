...
class Exports(object):
    ...
    def _add(self, context: typing.Optional[str], setting: str, value: typing.Any):
        if context == None:
    ...
    def get_all(self, setting: str) -> typing.List[typing.Any]:
        return self._exports.get(setting,
                                 []) + sum([exports.get(setting,
                                                        []) for exports in self._context_exports.values()],
                                           [])


    def get_one(self, setting: str, default: typing.Any = None) -> typing.Optional[typing.Any]:
